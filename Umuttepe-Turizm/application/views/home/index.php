							...
							<form method="post" action="tickets">
								<div class="bg-white p-3 rounded" style="opacity: 0.7;">
										...
										<div class="col-12">
											<div class="form-check">
												...
												<label for="flexRadio2" class="l-radio">
													<input type="radio" id="flexRadio2" name="seferTuru" tabindex="2"
														   value="2" checked>
									...
									<div class="row p-2">
										...
										<button type="submit" class="btn btn-dark p-2 mx-auto"
		...
		<div class="row">
			<div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
				<div class="list-box d-flex align-items-center">
					...
					<div class="content">
						...
						<p>Firmaların otobüs biletlerini karşılaştırabilir, uygun otobüs biletini bulabilir ve çevrimiçi
			...
			<div class="col-lg-4 col-md-6">
				<div class="list-box d-flex justify-content-start align-items-center">
					...
					<div class="content">
						<h3>Güvenli Ödeme</h3>
						<p>Tüm otobüs bilet alım işlemlerinizi cep telefonunuzdan kolay, hızlı ve güvenilir bir şekilde
...
<nav class="accordion arrows mt-5 mb-5 w-100 p-3 container">
	...
	<section class="box">
		...
		<div class="box-content">Umuttepe Turizm'den otobüs bileti satın almak için web sitemizi kullanabilirsiniz.
			Seyahat etmek istediğiniz yeri ve tarihi girdikten sonra tüm seferleri karşılaştırabilir, size uygun sefer
	...
	<section class="box">
		...
		<div class="box-content">Sitemiz üzerinden biletinizi güvenle satın alabilirsiniz. Sitemizden yapacağınız
			alışverişler SSL sertifikası ile güvence altına alınır. Ayrıca otobüs bileti satın alırken ödeme adımında 3D
