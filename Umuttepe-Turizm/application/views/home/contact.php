			...
			<div class="row">
				<div class="col-lg-8 offset-lg-2 text-center">
					<div class="breadcrumb-text">
						<p>Biz Buradayız - 24/7 Cevap Veriyoruz!</p>
						<h1>İletişim</h1>
					</div>
				</div>
			</div>
				...
				<div class="col-lg-4">
					<div class="contact-form-wrap">
						<div class="contact-form-box">
							<h4><i class="fas fa-map"></i> Umuttepe Adresimiz</h4>
							<p>Kabaoğlu, 41001 <br> İzmit, Kocaeli. <br> Türkiye</p>
						</div>
						<div class="contact-form-box">
							<h4><i class="far fa-clock"></i> Mesai Saatlerimiz</h4>
							<p>Pzt - Cuma: 08:00 - 19:00 <br> Ctesi - Pazar: 10:00 - 18:00 </p>
						</div>
						<div class="contact-form-box">
							<h4><i class="fas fa-address-book"></i> İletişim</h4>
							<p>Phone: +90 548 453 34 45  <br> Email: bilgi@umuttepeturizm.com</p>
						</div>
					</div>
				</div>
			</div>
