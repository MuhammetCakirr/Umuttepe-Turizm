                ...
                <ul class="nav nav-pills card-header-pills">
                    <li class="nav-item">
                        <div class="flex-container">
                            ...
                            <div>
                                <strong>9 Mart 2024, Cumartesi</strong>
                            </div>
                    ...
                    <form class="row" style="width: 100%;">
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <div class="form-group">
                                <label for="account-fn"> <strong>Nereden</strong> </label>
                                <input class="form-control" type="text" id="account-fn" value="İstanbul" required>
                            </div>
                        </div>
                        <div class="col-lg-3  col-md-6 col-sm-12">
                            <div class="form-group">
                                <label for="account-ln"> <strong>Nereye</strong> </label>
                                <input class="form-control" type="text" id="account-phone" value="Ankara" required>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <div class="form-group">
                                <label for="dtarihi"> <strong>Gidiş Tarihi</strong> </label>
                                <input class="form-control" type="datetime" id="dtarihi" value="9 Mart 2024, Cumartesi">
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <div class="form-group">
                                <label for="searchbtn" style="visibility: hidden;"> Button </label>
                                <button class="search-button" style="width:100%;" id="searchbtn">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            <div
                                ...
                                <p style="font-size: 16px;">10:00</p>
                            </div>
                            <p style="font-size: 12px;">(3 Saat 30 Dakika)*</p>
                        </div>
                        ...
                        <div class="col-lg-2">
                            <strong style="font-size: 25px;">376 TL</strong>
                        </div>
