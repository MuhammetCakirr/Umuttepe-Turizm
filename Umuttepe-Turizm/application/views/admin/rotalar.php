...
<head>
    ...
    <title>Umuttepe Turizm - Şehirler</title>
                            ...
                            <div class="table-responsive text-nowrap">
                              <table class="table table-hover">
                                ...
                                <tbody class="table-border-bottom-0">
                                  <tr>
                                    <td ><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong id="indirimadi">Genç (13-26)</strong></td>
                                  ...
                                  <tr>
                                    <td ><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong id="indirimadi">Öğrenci (13-26)</strong></td>
