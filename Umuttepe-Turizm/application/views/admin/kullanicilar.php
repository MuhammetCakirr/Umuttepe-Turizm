...
<head>
  ...
  <title>Umuttepe Turizm - Kullanıcılar</title>
    ...
    <div class="layout-container">
      ...
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        ...
        <ul class="menu-inner py-1">
          <!-- Dashboard -->
          <li class="menu-item ">
            <a href="<?php $current_url = "admin" ? "admin" : "admin" ?>" class="menu-link">
          ...
          <li class="menu-item active">
            <a href="<?php $current_url = "admin/kullanicilar" ? "/kullanicilar" : "admin" ?>" class="menu-link">
              <i class="menu-icon tf-icons bx bx-home-circle"></i>
          ...
          <li class="menu-item ">
            <a href=" " class="menu-link">
              <i class="menu-icon tf-icons bx bx-home-circle"></i>
              <div data-i18n="Analytics"><?php echo $current_url?></div>
            </a>
          </li>
          <li class="menu-item ">
              ...
              <div class="table-responsive text-nowrap">
                <table class="table">
                  ...
                  <tbody class="table-border-bottom-0">
                    <tr>
                      <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>Muhammet Çakır</strong></td>
                      <td>Erkek</td>
                      <td>
                        28/10/2003
                      ...
                      <td><span class="badge bg-label-primary me-1">5454462969</span></td>
                      <td>
                      ...
                      <td>
                        <span class="badge bg-label-success me-1">554 TL</span>
                        <!-- <div class="dropdown">
                                <button type="button" class="btn p-0 dropdown-toggle hide-arrow" data-bs-toggle="dropdown">
                                  <i class="bx bx-dots-vertical-rounded"></i>
                                </button>
