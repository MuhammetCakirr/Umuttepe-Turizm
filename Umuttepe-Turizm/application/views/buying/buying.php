        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="kutular">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-sm-12 form-group">
                            ...
                            <input class="form-control" type="text" id="account-fn" name="fullName" required>
                        </div>
                        <div class="col-lg-6 col-sm-12 form-group">
                ...
                <div class="kutular">
                    ...
                    <p style="margin-top: 5px; color:blue;">27. Koltuk yolcu bilgisi</p>
                    <div class="row">
                        <div class="col-lg-6 col-sm-12 form-group">
                ...
                <div class="kutular">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-sm-12 form-group">
                            ...
                            <input class="form-control" type="text" id="account-fn" name="fullName" placeholder="XXX"
                                required>
                        </div>
                    ...
                    <button class="custom-button">
                        ...
                        <div style="display: flex; flex-direction:column">
                            <span> <strong>370 TL</strong> </span>
            ...
            <div class="col-lg-4">
                ...
                <div class="kutular" style="padding: 0px; important!">
                    ...
                    <div style="display:flex; flex-direction:row; padding-left: 10px; padding-right: 10px;">
                        ...
                        <p id="kalkis" class="sefer-p" style="margin-left: 6px;">İstanbul</p>
                    </div>
                    <div style="display:flex; flex-direction:row; padding-left: 10px; padding-right: 10px;">
                        <label for="kalkis"><Strong>Varış : </Strong> </label>
                        <p id="kalkis" class="sefer-p" style="margin-left: 6px;">Balıkesir</p>
                    </div>
                    <div style="display:flex; flex-direction:row; padding-left: 10px; padding-right: 10px;">
                    ...
                    <div style="display:flex; flex-direction:row; padding-left: 10px; padding-right: 10px;">
                        ...
                        <p id="kalkis" class="sefer-p" style="margin-left: 6px;">9 Mart Cumartesi</p>
                    </div>
                    <div style="display:flex; flex-direction:row; padding-left: 10px; padding-right: 10px;">
                        <label for="kalkis"><Strong>Saat : </Strong> </label>
                        <p id="kalkis" class="sefer-p" style="margin-left: 6px;">14:00</p>
                    </div>
                    <div style="display:flex; flex-direction:row; padding-left: 10px; padding-right: 10px;">
                    ...
                    <div style="display:flex; flex-direction:row;">
                        ...
                        <p class="sefer-p" style="margin-left: 6px;"> 6sa 11dk </p>
                    </div>
                    <div style="display:flex; flex-direction:row; padding-left: 10px; padding-right: 10px;">
