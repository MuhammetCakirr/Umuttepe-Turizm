...
<body>
    ...
    <div class="container" style="margin-top: 130px;">
        <div class="row">
            <div class="col-lg-8" id="contentPlaceholder" style="background-color:whitesmoke">
                ...
                <div class="author-card pb-3">
                    ...
                    <div class="author-card-profile">
                        ...
                        <div class="author-card-details">
                            <h5 class="author-card-name text-lg">Muhammet Çakır</h5><span
                                class="author-card-position">mamicakir30@gmail.com</span>
                        </div>
                    </div>
                </div>
                <div class="wizard">
                        ...
                        <a class="list-group-item" data-content="application/views/settings/hesap_bilgilerim.php" href="#">
                            ...
                            <!-- <div class="d-flex justify-content-between align-items-center">
                                <div><i class="fe-icon-shopping-bag mr-1 text-muted"></i>
                                    <div class="d-inline-block font-weight-medium text-uppercase">Hesap Bilgileri</div>
