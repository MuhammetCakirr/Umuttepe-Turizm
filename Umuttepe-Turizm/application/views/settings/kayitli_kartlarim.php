...
<script>
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    name.addEventListener('input', updateCard);
    ...
    function updateCard() {
      ...
      svgexpire.textContent = expirationdate.value || '01/23';
...
<div class="payment-title" style="margin-top: 10px;">
...
<div class="row">
  <div class="col-lg-6 col-md-12- col-sm-12">
    ...
    <div class="col-12">
      <div class="d-flex flex-wrap justify-content-between align-items-center" style="display: flex;">
        <div style="flex=1">
        <button class="btn btn-style-1 btn-primary" type="button" data-toast data-toast-position="topRight"
          ...
          data-toast-message="Your profile updated successfuly.">Kartı Güncelle</button>
        </div>

        <div style="flex=1">
        
        <button class="btn btn-style-1 btn-warning" type="button" style="background-color:red; color:white;">Kartı Sil</button>
        </div>
