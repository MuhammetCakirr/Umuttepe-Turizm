...
(function () {
  ...
  const totalRevenueChartEl = document.querySelector('#totalRevenueChart'),
    totalRevenueChartOptions = {
      ...
      xaxis: {
        categories: ['Pazartesi', 'Salı', 'Çarş.', 'Perş.', 'Cuma', 'Cumartesi', 'Pazar'],
        labels: {
          style: {
            fontSize: '13px',
            colors: axisColor
...
if (typeof encoksatissefer !== undefined && encoksatissefer !== null) {
  const totalRevenueChartt = new ApexCharts(encoksatissefer, totalRevenueChartOptionss);
  totalRevenueChartt.render();
}
